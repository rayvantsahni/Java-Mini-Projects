...
public class TransitCalculator
{
    ...
    public TransitCalculator(int numberOfDays, int numberOfRides, int ageOfPerson)
    {
...
//        System.out.println(Arrays.toString(pricePerRide));
    ...
    {
        return "You will ride " + rides + " times in " + days + " days (Age: " + age + ")\n";
    }

    public static void main(String[] args)
    {
        TransitCalculator person1 = new TransitCalculator(12, 82, 60);
        TransitCalculator person2 = new TransitCalculator(12, 82, 90);
        TransitCalculator person3 = new TransitCalculator(23, 16, 42);
